...
export default class WorkEdit extends Component {
  ...
  render () {
    ...
    return (
      <div>
        <DarkBackgroundWithText text={'Тук се показва произведението за редакция'} smallText={'Може да редактирте или да се откажете'}/>
            ...
            <div className="row">
              <div className="col-sm-11 col-sm-offset-1 mb-sm-40">
                ...
                >
                  ...
                  <div>
                    <h3 style={{color: 'red'}}>Вида на тескта не може да бъде променян</h3>
                    <h3 style={{color: 'red'}}>Ако искате да го направите от друг тип ще трябва да го изтриете и да създадете ново</h3>
                  </div>
                  ...
                  <RadioElement
                    ...
                    handleChange={EditActions.handleLyricsWorkChange}
                    selectedValue={this.state.workType}
                    customStyle={{marginLeft: 0, paddingBottom: 10 + 'px', display: 'block'}}
                  />
                  ...
                  <Link to={`/administration/authors/${searchObject.authorName}`}
